...
AssimpLoader::AssimpLoader() {
    ...
    light_switch = GetUniformLocation(shaderProgramID, "lightSwitch");
    vertexNormalLocation = glGetAttribLocation(shaderProgramID, "vertexNormal");
    lightIntensity = 1.0;
...
void AssimpLoader::Render3DModel(glm::mat4 *mvpMat) {
    ...
    glUniform1f(light_switch, lightIntensity);
...
void AssimpLoader::turnOnLight() {
    lightIntensity = 1.0;

}

void AssimpLoader::turnOffLight() {
    lightIntensity = 0.0;
}
